...
export default function ProfilePage() {
  ...
  // Initialize form
  const { register, handleSubmit, setValue, setErrors, isSubmitting } = useForm<ProfileFields>({
    ...
    onSubmit: async (values) => {
      ...
      const res = await HTTPS.put<any>("/user/profile", values);
    ...
    <div className="p-6 md:p-10 max-w-3xl mx-auto space-y-8">
      ...
      <Card variant="default">
        <CardHeader>
          ...
          <CardDescription>Update your contact details and how we reach you.</CardDescription>
        </CardHeader>
        <CardDivider />
      ...
      <Card variant="tinted" className="bg-zinc-50 border-zinc-200">
        <CardContent className="py-5 flex flex-col sm:flex-row sm:items-center justify-between gap-4">
          <div>
            <h3 className="text-sm font-bold text-zinc-900">Identity Verification (KYC)</h3>
