    ...
    <div className="p-6 md:p-10 max-w-3xl mx-auto space-y-8">
      ...
      <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4">
        <div>
          ...
          <p className="text-zinc-500 mt-1">
            Choose what you want to be notified about and how we should reach
            you.
          </p>
        </div>
        <Button
      ...
      <Card variant="default">
        <CardHeader>
          ...
          <CardDescription>
            Updates sent directly to your registered email address.
          </CardDescription>
        </CardHeader>
        <CardDivider />
          ...
          <div className="divide-y divide-zinc-100 dark:divide-zinc-800">
            <div className="flex items-center justify-between p-5 sm:px-6">
              <div className="pr-4">
                ...
                <p className="text-xs text-zinc-500 mt-0.5">
                  Receive receipts for deposits and alerts when your payout is
                  ready.
                </p>
              </div>
              <Toggle
                checked={prefs.email_payouts}
                onChange={() => handleToggle("email_payouts")}
              />
            </div>
            ...
            <div className="flex items-center justify-between p-5 sm:px-6">
              <div className="pr-4">
                ...
                <p className="text-xs text-zinc-500 mt-0.5">
                  Get notified when someone invites you to join a new savings
                  circle.
                </p>
              </div>
              <Toggle
                checked={prefs.email_invites}
            ...
            <div className="flex items-center justify-between p-5 sm:px-6">
              <div className="pr-4">
                ...
                <p className="text-xs text-zinc-500 mt-0.5">
                  Receive tips, newsletters, and promotional offers from
                  AjoSave.
                </p>
              </div>
              <Toggle
      ...
      <Card variant="default">
        <CardHeader>
          ...
          <CardDescription>
            Alerts delivered to your device via the AjoSave app or browser.
          </CardDescription>
        </CardHeader>
        <CardDivider />
        <CardContent className="p-0">
          <div className="divide-y divide-zinc-100 dark:divide-zinc-800">
            <div className="flex items-center justify-between p-5 sm:px-6">
              <div className="pr-4">
                ...
                <p className="text-xs text-zinc-500 mt-0.5">
                  Real-time alerts for circle messages, member joins, and system
                  updates.
                </p>
              </div>
              <Toggle
                checked={prefs.push_activity}
                onChange={() => handleToggle("push_activity")}
              />
            </div>
            ...
            <div className="flex items-center justify-between p-5 sm:px-6">
              <div className="pr-4">
                ...
                <p className="text-xs text-zinc-500 mt-0.5">
                  Helpful nudges 24 hours before your circle contribution is
                  due.
                </p>
              </div>
              <Toggle
      ...
      <Card variant="default">
        <CardHeader>
          ...
          <CardDescription>
            Critical alerts sent via text message to your phone number.
          </CardDescription>
        </CardHeader>
        <CardDivider />
        <CardContent className="p-0">
            ...
            <div className="flex items-center justify-between p-5 sm:px-6 bg-zinc-50/50 dark:bg-zinc-900/50 rounded-b-xl">
              <div className="pr-4 flex items-start gap-3">
                ...
                <div>
                  ...
                  <p className="text-xs text-zinc-500 mt-0.5">
                    We always send an SMS for login codes, password resets, and
